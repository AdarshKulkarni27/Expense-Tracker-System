...
function Budget({ currentPath, onNavigate, authSession, onLogout }) {
  ...
  const isViewingPastMonth = month < currentMonthValue;
        ...
        <section className="budget-stack">
          {isLoading ? (
                ...
                <div className="budget-row__top">
                  ...
                  <div className="budget-row__side">
                    ...
                    <div className="budget-row__actions">
                      {isViewingPastMonth ? (
                        <span className="budget-row__readonly">Read only</span>
                      ) : (
                        <>
                          <button
            ...
            <div className="empty-state">
              ...
              <p>
                {isViewingPastMonth
                  ? "Past months are view-only. Switch to the current or a future month to add budgets."
                  : "Add your first category budget to start tracking monthly limits."}
              </p>
            </div>
          )}
        </section>
