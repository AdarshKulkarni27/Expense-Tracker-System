  ...
  return (
    <section className="summary-grid">
      <article className="summary-card summary-card--primary">
        ...
        <h2>{formatCurrency(dashboard.totalSpent || 0)}</h2>
      ...
      <article className="summary-card summary-card--success">
        ...
        <h2>{formatCurrency(dashboard.averageSpent || 0)}</h2>
        <p className="summary-card__meta">per active day</p>
      </article>

      <article className="summary-card summary-card--accent">
        <p className="summary-card__label">Top Category</p>
        <h2>{dashboard.topCategory || "No data yet"}</h2>
        <p className="summary-card__meta">
          {dashboard.topCategoryAmount
            ? formatCurrency(dashboard.topCategoryAmount)
            : "Waiting for data"}
        </p>
      </article>
    </section>
